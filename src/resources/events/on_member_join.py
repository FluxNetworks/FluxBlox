...
guild_obligations, get_user, send_account_confirmation, mask_unverified = Fluxblox.get_module("roblox", attrs=["guild_obligations", "get_user", "send_account_confirmation", "mask_unverified"])


@Fluxblox.module
class MemberJoinEvent(Fluxblox.Module):
    def __init__(self):
        pass

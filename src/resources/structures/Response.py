...
from ..structures import Fluxblox, Paginate, Args # pylint: disable=no-name-in-module, import-error
...
get_features = Fluxblox.get_module("premium", attrs=["get_features"])
cache_set, cache_get, cache_pop = Fluxblox.get_module("cache", attrs=["set", "get", "pop"])
...
class ResponseLoading:
    ...
    async def _send_loading(self):
        try:
            future = Fluxblox.wait_for("reaction_add", check=self._check_reaction(self.original_message), timeout=60)
...
class Response(Fluxblox.Module):
    ...
    async def error(self, text, *, embed_color=0xE74C3C, embed=None, dm=False, **kwargs):
        emoji = "<:FluxbloxDead:823633973967716363>"
    ...
    async def confused(self, text, *, embed_color=0xE74C3C, embed=None, dm=False, **kwargs):
        emoji = "<:FluxbloxConfused:823633690910916619>"
    ...
    async def success(self, success, embed=None, embed_color=0x36393E, dm=False, **kwargs):
        emoji = "<:FluxbloxHappy:823633735446167552>"
    ...
    async def silly(self, text, embed=None, embed_color=0x36393E, dm=False, **kwargs):
        emoji = "<:FluxbloxSilly:823634273604468787>"
    ...
    async def info(self, text, embed=None, embed_color=0x36393E, dm=False, **kwargs):
        emoji = "<:FluxbloxDetective:823633815171629098>"

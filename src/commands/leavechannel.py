...
@Fluxblox.command
class LeaveChannelCommand(Fluxblox.Module):
    ...
    async def verified(self, CommandArgs):
        """set the leave message of people who are VERIFIED on Fluxblox"""
        ...
        if verified_message:
            response.delete(await response.send("When people leave your server and are **VERIFIED** on Fluxblox, this message "
                                                "will be posted:"))
    ...
    async def unverified(self, CommandArgs):
        """set the leave message of people who are UNVERIFIED on Fluxblox"""
        ...
        if unverified_message:
            response.delete(await response.send("When people leave your server and are **UNVERIFIED** on Fluxblox, this message "
                                                "will be posted:"))

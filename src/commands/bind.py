...
get_group, count_binds, get_binds = Fluxblox.get_module("roblox", attrs=["get_group", "count_binds", "get_binds"])
...
@Fluxblox.command
class BindCommand(Fluxblox.Module):
        ...
        parsed_args = await CommandArgs.prompt([
            ...
            },
            {
                "prompt": "Should any **additional** roles be **removed from the user** if they meet the bind conditions? You can specify multiple roles.\n\n"
                          "Note that this is an **advanced option**, so you most likely should `skip` this. Fluxblox will already remove \"old\" Group roles.\n\n"
